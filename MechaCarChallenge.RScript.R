...
t.test((subset(mecha_coil,manufacturing_lot='lot1')$PSI),mu=mean(mecha_coil$PSI))

t.test((subset(mecha_coil,manufacturing_lot='lot2')$PSI),mu=mean(mecha_coil$PSI))

t.test((subset(mecha_coil,manufacturing_lot='lot3')$PSI),mu=mean(mecha_coil$PSI))
